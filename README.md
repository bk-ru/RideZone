...
- **Графики сходимости модели (loss curves):** `docs/experiments/loss_curve.png`
...
```
При необходимости можно указать собственный датасет: `python scripts/run_experiments.py --input data/processed/features.parquet --target demand`.
