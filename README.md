...
## 🖼️ Примеры функционала

1. **Интерактивная карта** — Leaflet‑карта с реальными данными, тумблерами «Тепловая карта / Кластеры / Станции» и всплывающими карточками по каждой зоне.
2. **Прогноз спроса** — Chart.js строит сравнение «текущий vs прогнозный» спрос по кластерам, учитывая сезонность и тип транспорта.
3. **Таблица рекомендаций** — динамическая таблица Top‑N станций с приоритетом, координатами, ожидаемым спросом и факторами покрытия.
